...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
	...
	protected void onPause() {
		fragment.getMapView().onPause();
		super.onPause();
	}

	@Override
	protected void onResume() {
		fragment.getMapView().onResume();
		super.onResume();
	}

	@Override
	protected void onDestroy() {
		fragment.getSearch().destroy();
		fragment.getMapView().onDestroy();
		super.onDestroy();
	}
	...
	private void showShare() {
		...
		oks.setText(fragment.getViews().getViewInfo());
