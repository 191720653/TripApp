...
//	private ListView listView;
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (changed && !loadOnce) {
			...
			selfListView = (SelfListView) findViewById(R.id.list_view);//getChildAt(1)
			selfListView.setOnTouchListener(this);
			loadOnce = true;
		}
	}
	...
	private void setIsAbleToPull(MotionEvent event) {
		View firstChild = selfListView.getChildAt(0);
		if (firstChild != null) {
			int firstVisiblePos = selfListView.getFirstVisiblePosition();
