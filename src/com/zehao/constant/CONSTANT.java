...
public class CONSTANT {
	 ...
	 * 服务器基本地址
	 */
	public static final String BASE_URL = "http://192.168.1.105:8080/TripServer/ZZHPAPP";
	
	/**
	 * 服务器根基本地址
	 */
	public static final String BASE_ROOT_URL = "http://192.168.1.105:8080/TripServer";
	 ...
	 * 路线规划交通类型：走路
	 */
	public static final String ROUTE_WALK = "route_walk";
	/**
	 * 路线规划交通类型：公交
	 */
	public static final String ROUTE_BUS = "route_bus";
	/**
	 * 路线规划交通类型：驾车
	 */
	public static final String ROUTE_DRIVE = "route_drive";
	/**
	 * 路线规划起点
	 */
	...
	/**
	 * 显示连接服务器对话框 value：ACTION_SHOW_DIALOG
	 */
	public static final int ACTION_SHOW_DIALOG = 10086;
	/**
