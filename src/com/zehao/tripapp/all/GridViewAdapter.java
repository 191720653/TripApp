...
public class GridViewAdapter extends BaseAdapter {
	private List<Other> listItems; // 信息集合
	...
	public GridViewAdapter(Context context, List<Other> listItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// 设置文字和图片
		ImageLoader.getInstance().displayImage(CONSTANT.BASE_ROOT_URL + listItems.get(position).getLogo().replaceFirst(".", ""), listItemView.image, options);
		// listItemView.image.setImageResource(Integer.parseInt(listItems.get(position).get("image").toString()));
		listItemView.title.setText((String) listItems.get(position).getName());
