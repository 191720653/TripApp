...
import com.zehao.tripapp.login.OnLoginListener;
...
public class SignupPage extends BaseActivity implements OnClickListener, Callback {
	...
	public void seregister_userinfoatform(String platName) {
	...
	private void initData(){
		...
		if(platform != null){
			...
			if(gender.equals("m")){
				...
				gender = getApplicationContext().getString(R.string.register_userinfo_boy);
			}else{
				userInfo.setUserGender("女");
				gender = getApplicationContext().getString(R.string.register_userinfo_girl);
			}
...
//			pv.show(activity, null);
	...
	private void showChangeIconDialog(){		
		final Dialog dialog = new Dialog(getApplicationContext(), R.style.WhiteDialog);
